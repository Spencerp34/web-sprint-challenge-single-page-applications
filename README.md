...
useRouteMatch is one of two ways to alter the end of the URL similar to <Route />. Useful for single page applications

1. How would you explain form validation to someone who has never programmed before?

A simple coding practice that ensures the information a form is looking for is the correct type and gives you options to display and error if not.

1. In 1-2 sentences, define end to end testing.

We can test individual components here and there but the E2E testing tests the entirety of the program for us at one test.
